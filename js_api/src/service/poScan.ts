...
async function txPutObject(api: ApiPromise, pubKey: string, password: string, msgId: string, category: any, file: any, nApprovals: number, hashes: any, props: any) {
    return new Promise(async (resolve) => {
        ...
        tx = api.tx.poScan.putObject(category, file, nApprovals, hashes, props);
